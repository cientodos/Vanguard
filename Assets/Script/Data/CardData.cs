...
public class CardData
{
    ...
    public List<string> tribeList = new List<string>();
    ...
    public CardData(
           ...
           List<CountryType> countryList, string tribeRaw, List<string> tribeList,
